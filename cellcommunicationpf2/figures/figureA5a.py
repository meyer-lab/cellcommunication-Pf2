...
def makeFigure():
    ...
    # Data type for values sparse or dense
    print(f"Data type: {adata_filtered.X.dtype}, is sparse: {adata_filtered.X.format if hasattr(adata_filtered.X, 'format') else 'No'}")
    ...
    plot_lr_factors(adata_filtered, ax[3], trim=True, weight=0.12)
